...
const About = () => {
  return (
    <>
      <section id="studio" className="my-14 md:my-20 lg:my-32">
      ...
      <section className="my-14 md:my-20 lg:my-32">
        <p className=" text-center text-xl lg:text-2xl italic">
          We’re drawing heavily from our daily lives crafting narratives that
          are moving, believable, and humane.
        </p>
      </section>
      <section className="my-14 md:my-20 lg:my-32 grid grid-cols-1 md:grid-cols-2 grid-rows-1 md:grid-rows-5">
        <div className="md:row-start-1 md:row-span-2 px-6 py-10 md:py-6 flex items-center">
        ...
        <div className="md:row-start-1 md:row-span-3">
          <Image
        ...
        <div className="order-2 md:order-none md:row-start-3 md:row-span-3">
          <Image
        ...
        <div className="md:row-start-4 md:row-span-2 px-6 py-10 md:py-6 flex items-center">
          <p className="italic text-xl lg:text-2xl">
      ...
      <section className="my-14 md:my-20 lg:my-32">
        <div className=" flex flex-col items-center space-y-16">
          ...
          <p className="text-center italic text-xl lg:text-2xl">
